...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL",
    "Smart Shippers Choice Support <support@smart-shippers-choi-50205.botics.co>",
)
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = (
        "smart_shippers_choi_50205.storage_backends.AzureMediaStorage"
    )
    STATICFILES_STORAGE = (
        "smart_shippers_choi_50205.storage_backends.AzureStaticStorage"
    )
